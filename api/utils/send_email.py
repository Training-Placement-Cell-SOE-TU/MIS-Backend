...
def send_email(receiver_address:str, mail_subject:str, training_details):
    load_dotenv()
                            ...
                            <table width="600" cellpadding="0" cellspacing="0" border="0" class="container">
                              ...
                              <tr>
                                <td align="center" class="hund ripplelink" width="600">
                                  <img align="center" width="600" style="border-radius: 3px 3px 0px 0px; width: 40%; object-fit: contain; max-width: 600px!important" class="hund" src="http://www.tezu.ernet.in/TP_ENGG/img/logo.png">
                                </td>
                              </tr>
                              <!-- END HEADER IMAGE -->
                              <!-- START BODY COPY -->
                              ...
                              <tr>
                                <td class="td-padding" align="left" style="font-family: 'Roboto Mono', monospace; color: #212121!important; font-size: 16px; line-height: 24px; padding-top: 18px; padding-left: 18px!important; padding-right: 18px!important; padding-bottom: 0px!important; mso-line-height-rule: exactly; mso-padding-alt: 18px 18px 0px 18px;">
                                  You have sucessfully registered for the training.
                                  <br>
                                  <br>
                                  Traning Name: ''' + training_details.training_name + '''
                                    <br>
                                    Traning Info: ''' + training_details.training_desc + '''
                                    <br>
                                    <br>
                                    Training Venue: ''' + training_details.training_venue + '''
                                    <br>
                                    Training Start Date: ''' + training_details.training_start_date + '''
                                    <br>
                                    Training End Date: ''' + training_details.training_end_date + '''
                                    <br>
                                    Training Time: ''' + training_details.training_time + '''
                                    <br>
                                    Trainer Name: ''' + training_details.trainer_name + '''
                                    <br>
                                    <br>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0">
                                          <tr>
                                            <td align="left" style="border-radius: 3px;" bgcolor="#234688">
                                              <a class="button raised" href="http://paulgoddarddesign.com/email-marketing" target="_blank" style="font-size: 14px; line-height: 14px; font-weight: 500; font-family: Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 3px; padding: 10px 25px; border: 1px solid #234688; display: inline-block;">Go</a>
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
